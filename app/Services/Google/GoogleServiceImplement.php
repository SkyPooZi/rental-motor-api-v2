...
use App\Repositories\Google\GoogleRepository;

class GoogleServiceImplement extends ServiceApi implements GoogleService
{
   ...
   */
  protected GoogleRepository $mainRepository;

  public function __construct(GoogleRepository $mainRepository)
  {
